<template>
  <el-card shadow="never">
    <div class="role">
      ...
      <pagination :current-page="currentPage" :total="total" @handleCurrentChange="handleCurrentChange" @handleSizeChange="handleSizeChange" />
      <add-form @queryUserList="queryUserList" />
      <edit-form :from="editModel" @queryUserList="queryUserList" />
    </div>
  </el-card>
</template>
